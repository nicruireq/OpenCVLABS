...
int main()
{
    ...
    cout << "Rows are: " << mat_train_labels.size().height << endl;
    cout << "Cols are: " << mat_train_labels.size().width << endl;
    ...
    // cout << "TEST VECTORD LABELS" << endl
    //      << mat_test_labels << endl;

    // Create an OpenCV MLP
    Ptr<ANN_MLP> mlp = ANN_MLP::load("ocr_model.xml");
    ...
    // cout << "PREDICTED MAT: " << endl
    //      << mat_predicted_test << endl;
